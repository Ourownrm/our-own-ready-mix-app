...
export const CHECKLIST_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "reverse_alarm", label: "Reverse Alarm" },
      { key: "lights_indicators", label: "Lights & Indicators" },
      { key: "horn", label: "Horn" },
      { key: "reflective_tape_markings", label: "Reflective Tape & Safety Markings" },
      { key: "first_aid_kit", label: "First Aid Kit" },
      { key: "vehicle_documents_available", label: "Vehicle Documents Available" },
    ],
  },
];
