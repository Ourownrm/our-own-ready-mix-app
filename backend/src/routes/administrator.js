...
// the driver before the truck leaves the plant. Returns every field the
// frontend PDF generator (deliveryChallanPdf.js) needs; the PDF itself is
// built client-side so there's nothing to store or regenerate server-side.
//
// Round 153 — the SQL moved to lib/challanData.js, because the Plant Operator,
