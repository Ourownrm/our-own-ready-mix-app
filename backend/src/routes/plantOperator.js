...
const router = Router();
router.use(requireAuth, requireRole("plant_operator", "qc_engineer", "manager", "administrator"));
...
router.post("/:ticketId/plant-qc", requireRole("qc_engineer", "plant_operator", "administrator"), async (req, res) => {
